...
import image1 from '../recursos/images/image1.jpg'
import image2 from '../recursos/images/image2.jpg'
import image3 from '../recursos/images/image3.jpg'
...
class Home extends React.Component{
    constructor(props) {
        ...
        bd.getInvocacion('/producto/consultar',dato => {  //Entrará acá cuando status = true
            this.setState({
                ProductList : dato.dato
            })
            console.log(dato)
                    ...
                    <div className="row">
                        <For each="item" index="index" of={this.state.ProductList} >
                            <div className="col-sm-6 col-md-4 col-lg-4">
                                {console.log("Probando recivo de datos: ", item.nomProducto)}
                                <CardsHome key={index} img={this.state.Imagenes[index]} title={item.Nombre} descripcion={item.Descripcion} precio={item.Precio} idProducto={item.idProducto}/>
                            </div>
                        </For>
                    </div>
                </div>
